...
#ifndef GLFW_KEY_CONTEXT_MENU
    #define GLFW_KEY_CONTEXT_MENU -1
#endif
...
namespace cangine {
    Key translateGLFWKey(int key) {
        switch (key) {
            ...
            case GLFW_KEY_CONTEXT_MENU: return Key::ContextMenu;
